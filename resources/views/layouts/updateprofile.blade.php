                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('update_profile') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="npm" type="text" class="form-control{{ $errors->has('no_identitas') ? ' is-invalid' : '' }}" name="no_identitas" value="{{ $mahasiswa->no_identitas }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="nama" type="text" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" name="nama" value="{{ $mahasiswa->nama }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="gender" class="form-control{{ $errors->has('jenis_kelamin') ? ' is-invalid' : '' }}" name="jenis_kelamin" value="{{ $mahasiswa->gender }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="tgl" type="date" class="form-control{{ $errors->has('mhs_tgl_lahir') ? ' is-invalid' : '' }}" value="{{ $mahasiswa->tgl_lahir }}" name="mhs_tgl_lahir" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="alamat" type="text" class="form-control{{ $errors->has('mhs_alamat_rmh') ? ' is-invalid' : '' }}" value="{{ $mahasiswa->alamat_rmh }}" name="mhs_alamat_rmh" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="angkatan" type="text" class="form-control{{ $errors->has('mhs_angkatan') ? ' is-invalid' : '' }}" name="mhs_angkatan" value="20{{substr($mahasiswa->no_identitas,6,2)}}" readonly>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="thn_lulus" class="form-control{{ $errors->has('mhs_thn_lulus') ? ' is-invalid' : '' }}" name="mhs_thn_lulus">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="skripsi" type="text" class="form-control{{ $errors->has('mhs_skripsi') ? ' is-invalid' : '' }}" name="mhs_skripsi" value="{{ $mahasiswa->skripsi }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $mahasiswa->email }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="no_wa" type="text" class="form-control{{ $errors->has('mhs_no_wa') ? ' is-invalid' : '' }}" name="mhs_no_wa" value="{{ $mahasiswa->no_wa }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="linkedin" type="url" class="form-control{{ $errors->has('mhs_linkedin') ? ' is-invalid' : '' }}" name="mhs_linkedin" value="{{ $mahasiswa->linkedin }}">
